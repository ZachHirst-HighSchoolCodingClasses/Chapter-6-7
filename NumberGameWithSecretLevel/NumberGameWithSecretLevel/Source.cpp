// Author Zach Hirst
// 4/27/18
// Random number generator with 3 levels and secret level
...
begin:
	...
	default:
	{
		...
		std::string password = "northhigh";
		std::cout << " Please enter the password for the secret level " << std::endl;
		std::cin >> secretPassword;
		if (secretPassword == password)
		{
			...
			do {
				std::cout << " Please guess a number between 1- 1000000 " << std::endl;
				std::cin >> userNum;
				if (userNum == secret)
				{
					std::cout << " Congratulations, you Win !! " << std::endl;
